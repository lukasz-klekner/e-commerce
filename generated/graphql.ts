...
export type ScheduledOperationAffectedDocument = Asset | Category | Collection | Currency | Order | OrderItem | Product | ProductColorVariant | ProductSizeColorVariant | ProductSizeVariant | Profile | Review;
...
export type CreateProfileMutation = { __typename?: 'Mutation', user?: { __typename?: 'Profile', id: string } | null };
...
export type GetProductBySlugQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, price: number, name: string, slug: string, images: Array<{ __typename?: 'Asset', url: string }> } | null };
...
export type GetProfileByEmailQuery = { __typename?: 'Query', profile?: { __typename?: 'Profile', id: string, email: string, password: string } | null };
...
export const CreateProfileDocument = gql`
  ...
  user: createProfile(data: {email: $email, password: $password}) {
    id
  }
}
    `;
...
export const GetProfileByEmailDocument = gql`
  ...
  profile(where: {email: $email}, stage: DRAFT) {
    id
    email
    password
  }
